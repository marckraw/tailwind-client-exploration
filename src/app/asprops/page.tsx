...
import {BlockquoteCitation} from "@/components/BlockquoteAsProps/BlockquoteCitation";
import {Blockquote} from "@/components/BlockquoteAsProps/Blockquote";
import {BlockquoteText} from "@/components/BlockquoteAsProps/BlockquoteText";
import {BlockquoteFooter} from "@/components/BlockquoteAsProps/BlockquoteFooter";
  ...
  return (
      <main>
        <div className={clsx("m-10")}>
          <h2>Default</h2>
          <Blockquote
            textComponent={(props) => <BlockquoteText id={"my_id"} {...props}>
            ...
            footerComponent={(props) => <BlockquoteFooter {...props}>
